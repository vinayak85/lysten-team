    ...
    if a=='b' or a=='c':
     if(today_date == date):
      ...
      if starttime != "":
       ...
       cnt_obj = frappe.db.sql(""" select count(*) from 1bd3e0294da19198.`tabObjective` where 1bd3e0294da19198.`tabObjective`.`user`= {0} and 1bd3e0294da19198.`tabObjective`.`select_date`= {1} """.format(employee,date), as_dict=1)
