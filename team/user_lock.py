...
def retrun_user_list_with_lock_flag(limit, offset):
	...
	designation,enabled,modified,ifnull(mobile_no1,"-") as mobile_no,
	...
	from `tabUser` where designation in('TBM','ABM','RBM','ZBM','SM','NBM','CRM') LIMIT {0}  OFFSET {1};""".format(limit, offset),as_dict=True);
