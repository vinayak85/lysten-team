...
erpnext.accounts.credit_noteController = erpnext.selling.SellingController.extend({
	setup: function(doc) {
	...
	make_sales_return: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.accounts.doctype.credit_note.credit_note.make_sales_return",
			frm: cur_frm
		})
	},
...
$.extend(cur_frm.cscript, new erpnext.accounts.credit_noteController({frm: cur_frm}));
...
cur_frm.cscript['Make Delivery Note'] = function() {
	frappe.model.open_mapped_doc({
		method: "erpnext.accounts.doctype.credit_note.credit_note.make_delivery_note",
		frm: cur_frm
	})
}
...
cur_frm.cscript.on_submit = function(doc, cdt, cdn) {
	...
	} else if(cint(frappe.boot.notification_settings.credit_note)) {
		cur_frm.email_doc(frappe.boot.notification_settings.credit_note_message);
	}
}
