...
def _execute(filters=None,  additional_query_columns=None):
	...
	for batch in batches:
		...
		and pi.delivery_date like concat({0}) and  pii.batch_no=concat({1})""".format(ss, gg), as_dict=1);
...
def get_months():
	return ['2016-01','2016-02','2016-03','2016-04','2016-05','2016-06','2016-07','2016-08','2016-09','2016-10','2016-11','2016-12',
